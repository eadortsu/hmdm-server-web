...
document.localization ['es_ES'] = {
    ...
    'about.line.1': 'Uniti MDM panel de control',
    ...
    'qrcode.help.line5': 'Este QR debe contener el ID del dispositivo de Uniti MDM (no necesitas ingresarlo en el dispositivo). Para agregar la ID del dispositivo al QR, ingresa la ID del dispositvo y presiona "Renovar".',
