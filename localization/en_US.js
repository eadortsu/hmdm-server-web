...
document.localization ['en_US'] = {
    ...
    'about.line.1': 'Uniti MDM control panel',
    ...
    'qrcode.help.line5': 'The QR code may contain the device ID for Uniti MDM (so you don\'t need to enter it on a mobile device). To embed the device ID into the QR code, enter the device ID on this screen and click "Renew".',
    ...
    'ie.browser.notice.2': 'Recommended Browser for Using Uniti MDM - <a href="https://support.google.com/chrome/answer/95346?co=GENIE.Platform%3DDesktop">Chrome</a>.',
