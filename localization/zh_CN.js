...
document.localization ['zh_CN'] = {
    ...
    'qrcode.help.line5':"QR码可能包含Uniti MDM的设备ID（因此您无需在移动设备上输入它）。要将设备ID嵌入QR码，请在此屏幕上输入设备ID，然後单击\"续订\"。",
    ...
    'ie.browser.notice.2' : '推荐的浏览器，用於使用Uniti MDM-<a href ="https://support.google.com/chrome/answer/95346?co=GENIE.Platform%3DDesktop">Chrome</a>.',
